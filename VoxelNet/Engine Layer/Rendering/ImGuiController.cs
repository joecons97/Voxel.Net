...
void main()
{
    outputColor = color * texture(in_fontTexture, texCoord);
        ...
        private void RenderImDrawData(ImDrawDataPtr draw_data)
        {
            ...
            _shader.Bind();
            GL.ProgramUniformMatrix4(_shader.Handle, _shader.GetUniformLocation("projection_matrix"), false, ref mvp);
            GL.ProgramUniform1(_shader.Handle, _shader.GetUniformLocation("in_fontTexture"), 0);
